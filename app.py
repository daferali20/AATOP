...
def format_gainers_for_telegram(df, price_range):
    ...
    message += "\n📊 *ملاحظة مهمه :* هذه الأسهم ليست توصية  للمضاربه اللحظية قد يؤدي التداول فيها الى خسائر فادحه او ارباح عاليه  انها عالية المخاطر خلك حذر عند التداول فيها او قم بمراجعة القوائمالمالية او سبب ارتفاعها"
    return message
